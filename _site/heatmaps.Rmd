...
knitr::include_graphics(path = file.path("https://raw.githubusercontent.com/eugejoh/gmobility/main/output/", list.files(here::here("output"), pattern = "heatmap_")))
```
...
knitr::include_graphics(path = file.path("https://raw.githubusercontent.com/eugejoh/gmobility/main/output/", list.files(here::here("output"), pattern = "heatmapON_")))
```
